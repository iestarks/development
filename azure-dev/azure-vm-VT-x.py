...
vm_name = 'vm-mgmt-vt-x'  # replace with your VM name
location = 'eastus'
...
vnet = network_client.virtual_networks.begin_create_or_update(
    ...
    'vm-mgmt-vt-x-nic',  # replace with your desired virtual network name
    vnet_params
).result()
...
public_ip_address = network_client.public_ip_addresses.begin_create_or_update(
    resource_group,  # replace with your resource group name
    'vm-mgmt-vtx-pub-ip',  # replace with your desired public IP name
    public_ip_params
).result()
...
nic = network_client.network_interfaces.begin_create_or_update(
    resource_group,  # replace with your resource group name
    'vm-mgmt-vt-x-nic',  # replace with your desired NIC name
    nic_params
).result()
...
vm_parameters = {
    ...
    'hardware_profile': {
        'vm_size': 'Standard_D3_v2'  # replace with your VM size
    },
    'storage_profile': {
        'image_reference': {
